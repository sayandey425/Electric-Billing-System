...
//		b1.setBorderPainted(false);
		...
		Image i2 = i1.getImage().getScaledInstance(290, 260, Image.SCALE_DEFAULT);
		ImageIcon i3 = new ImageIcon(i2);
		JLabel l6 = new JLabel(i3);
		l6.setBounds(450, 50, 240, 250);
		p1.add(l6);	
	}
			...
			if(ae.getSource() == b1) {
				...
				try {
					...
					if(user.equals("Admin")) {
						str = "INSERT INTO login value('"+meter+"','"+username+"','"+name+"','"+password+"','"+user+"')";
					}else {
